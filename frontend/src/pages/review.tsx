        ...
        <main className="main-content">
          <div className="wide-container">
            <div className="page-header">
              <h1>Review Queue</h1>
              <p>
                Submitted intake requests from across the organization. Review each request and
                create a Jira ticket to begin the engagement.
              </p>
            </div>
                        ...
                        return (
                          <tr key={req.id}>
                            <td>
                              ...
                              <div className="table-submitter">{req.name}</div>
                            </td>
                            <td>{req.department}</td>
                            <td>
                              <Badge value={req.sensitivity_level ?? ''} type="sensitivity" />
                            </td>
                            <td>
...
function JiraAction({ requestId, jiraState, alreadySent, onCreateJira }: JiraActionProps) {
    ...
    return (
      <span
        style={{
          ...
          gap: '6px',
          fontSize: '0.8125rem',
          color: 'var(--status-jira-text)',
          background: 'var(--status-jira-bg)',
          padding: '3px 8px',
  ...
  return (
    <Button
      variant="secondary"
      size="sm"
      onClick={() => onCreateJira(requestId)}
      aria-label={`Create Jira ticket for request ${requestId}`}
    >
      Create Jira Ticket
    </Button>
  );
